...
(()=>{
    const e = new Error("Cannot find module './AuthModal.css'");
...
;
;
// قائمة النطاقات المسموح بها من الشركات العالمية
...
function AuthModal({ isOpen, onClose, onLoginSuccess }) {
    ...
    // CAPTCHA State & Ref
    const [captchaToken, setCaptchaToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    // دالة التحقق من مزود البريد الإلكتروني
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
        // 1. التحقق من المزود المسموح للبريد
        if (!isAllowedEmail(email)) {
            alert(`Please use a valid email address from global providers: (${ALLOWED_DOMAINS.slice(0, 5).join(', ')}, etc.)`);
            return;
        }
        // 2. التحقق من إكمال الكابتشا
        if (!captchaToken) {
        ...
        // تجهيز بيانات المستخدم للنقل
        const userData = {
            name: isSignUp ? fullName : fullName || email.split('@')[0],
            email: email
        };
        if (onLoginSuccess) {
...
_s(AuthModal, "9mtoJRkQuX+gAnO6CBqq/Ta1Vv8=");
_c = AuthModal;
var _c;
...
//# sourceMappingURL=_15iueo1._.js.map